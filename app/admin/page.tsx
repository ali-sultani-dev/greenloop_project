      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-emerald-600">{enhancedUserStats?.total_co2_saved}</div>
              <div className="flex items-center gap-2 mt-2">
                <div className="flex items-center text-xs text-emerald-600">
                  <ArrowUpRight className="h-3 w-3 mr-1" />+{actionGrowth} actions this month
                </div>
              </div>
              <p className="text-xs text-muted-foreground mt-1">Total Green Score across platform</p>
            </CardContent>
          </Card>
        </div>
